...
Built as a portfolio project to demonstrate skills required for the **Analyst (with Python)** role in quantitative trading firms (e.g., Eqvilent).
...
Python-based Market Data Validation & Cleaning Pipeline for quantitative trading research. Generates realistic tick data, detects anomalies (outliers, gaps, missing values), cleans with audit trail, and provides an interactive Streamlit tool to upload, validate, and download research-ready datasets. Demonstrates data quality assurance and internal tool-building skills.
